<%@ Page Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="DesignAdd.aspx.cs" Inherits="admin_DesignAdd" Title="无标题页"  ValidateRequest="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:FormView ID="FormView1" runat="server" 
      ...
      HorizontalAlign="Left" Width="100%" DataKeyNames="Id" oniteminserting="FormView1_ItemInserting" 
         >
       <InsertItemTemplate>
            ...
            <cc1:ImageUploader ID="ImageUploader1" runat="server" AllowMulti="False" 
                ...
                WatermarkType="Text" onuploaded="ImageUploader1_Uploaded" MaxSize="200" />
            <br />
            ...
            <asp:ImageButton ID="ImageButton1" runat="server" 
                ImageUrl="~/images/insert.jpg" CommandName="insert"  />
