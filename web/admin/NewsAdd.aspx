<%@ Page Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="NewsAdd.aspx.cs" Inherits="admin_NewsAdd" Title="无标题页" ValidateRequest="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
      SelectMethod="Newsinsert" TypeName="BLL.BLLNews" InsertMethod="Newsinsert">
