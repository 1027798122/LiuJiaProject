<%@ Page Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="ArticleAdd.aspx.cs" Inherits="admin_ArticleAdd" Title="无标题页" ValidateRequest="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div id="News">
    ...
    <asp:FormView ID="FormView1" runat="server" 
      DataSourceID="ObjectDataSource1" DefaultMode="Insert" Height="100%" 
      HorizontalAlign="Left" Width="100%" oniteminserting="FormView1_ItemInserting" 
      >
       <InsertItemTemplate>
            题目:<asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Title") %>' ></asp:TextBox>
            作者：<asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("Author") %>'></asp:TextBox>
            天气：<asp:TextBox ID="TextBox3" runat="server" Height="24px" 
                Text='<%# Bind("Weather") %>' Width="88px"></asp:TextBox>
            <br />
            ...
            <br />
            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/insert.jpg" CommandName="insert"  />
            
       </InsertItemTemplate>
  </asp:FormView>
  <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
      InsertMethod="Articleinsert" SelectMethod="Articleliste" 
      TypeName="BLL.BLLArticle">
      <SelectParameters>
